...
export function PomodoroTimer() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("notification_settings_changed", handleNotificationSettingsChange as EventListener);
    ...
    return () => {
      window.removeEventListener("notification_settings_changed", handleNotificationSettingsChange as EventListener);
    };
